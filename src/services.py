# This is service architecture
# Don't want main.py to have access to databases. The main.py will have accesses to the services.py
# this file is the middle man between the database ---> services.py ---> main.py
